...
export const MikeIcon = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
            <rect x='9.0004' y='3' width='6' height='10' rx='3' fill='white' />
            <path
...
export const MemoIcon = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
            <rect x='5' y='4' width='14' height='15' rx='2' fill='white' />
...
export const RecycleIcon = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
            <rect x='6' y='5' width='12' height='2' rx='0.5' fill='white' />
            <rect x='9' y='4' width='6' height='2' rx='0.5' fill='white' />
            <path d='M7 8H17V19C17 19.5523 16.5523 20 16 20H8C7.44772 20 7 19.5523 7 19V8Z' fill='white' />
        </svg>
    );
};
...
export const PrintIcon = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
            <mask id='path-1-inside-1_12921_31038' fill='white'>
                <rect x='2' y='7' width='20' height='10' rx='1' />
            </mask>
            <rect x='2' y='7' width='20' height='10' rx='1' stroke='white' strokeWidth='4' mask='url(#path-1-inside-1_12921_31038)' />
            <mask id='path-2-inside-2_12921_31038' fill='white'>
                <path d='M6 4C6 3.44772 6.44772 3 7 3H17C17.5523 3 18 3.44772 18 4V9H6V4Z' />
            </mask>
            <path
                d='M6 4C6 3.44772 6.44772 3 7 3H17C17.5523 3 18 3.44772 18 4V9H6V4Z'
                stroke='white'
                strokeWidth='4'
                mask='url(#path-2-inside-2_12921_31038)'
            />
            <path
                ...
                fill='white'
            />
            <path d='M8 14H16' stroke='#E5E7FA' strokeLinecap='round' />
            <path d='M8 16H16' stroke='#E5E7FA' strokeLinecap='round' />
            <path d='M8 18H12' stroke='#E5E7FA' strokeLinecap='round' />
        </svg>
    );
};
